...
module soc_system_mm_interconnect_3 (
	...
	wire    [0:0] hps_only_master_master_limiter_cmd_src_valid;                              // hps_only_master_master_limiter:cmd_src_valid -> limiter_pipeline:in_valid
	wire  [117:0] hps_only_master_master_limiter_cmd_src_data;                               // hps_only_master_master_limiter:cmd_src_data -> limiter_pipeline:in_data
	wire          hps_only_master_master_limiter_cmd_src_ready;                              // limiter_pipeline:in_ready -> hps_only_master_master_limiter:cmd_src_ready
	wire    [1:0] hps_only_master_master_limiter_cmd_src_channel;                            // hps_only_master_master_limiter:cmd_src_channel -> limiter_pipeline:in_channel
	wire          hps_only_master_master_limiter_cmd_src_startofpacket;                      // hps_only_master_master_limiter:cmd_src_startofpacket -> limiter_pipeline:in_startofpacket
	wire          hps_only_master_master_limiter_cmd_src_endofpacket;                        // hps_only_master_master_limiter:cmd_src_endofpacket -> limiter_pipeline:in_endofpacket
	...
	wire          limiter_pipeline_001_source0_valid;                                        // limiter_pipeline_001:out_valid -> hps_only_master_master_limiter:rsp_sink_valid
	wire  [117:0] limiter_pipeline_001_source0_data;                                         // limiter_pipeline_001:out_data -> hps_only_master_master_limiter:rsp_sink_data
	wire          limiter_pipeline_001_source0_ready;                                        // hps_only_master_master_limiter:rsp_sink_ready -> limiter_pipeline_001:out_ready
	wire    [1:0] limiter_pipeline_001_source0_channel;                                      // limiter_pipeline_001:out_channel -> hps_only_master_master_limiter:rsp_sink_channel
	wire          limiter_pipeline_001_source0_startofpacket;                                // limiter_pipeline_001:out_startofpacket -> hps_only_master_master_limiter:rsp_sink_startofpacket
	wire          limiter_pipeline_001_source0_endofpacket;                                  // limiter_pipeline_001:out_endofpacket -> hps_only_master_master_limiter:rsp_sink_endofpacket
	wire          hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_valid;                        // hps_0_f2h_axi_slave_wr_cmd_width_adapter:out_valid -> agent_pipeline:in_valid
	wire  [153:0] hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_data;                         // hps_0_f2h_axi_slave_wr_cmd_width_adapter:out_data -> agent_pipeline:in_data
	wire          hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_ready;                        // agent_pipeline:in_ready -> hps_0_f2h_axi_slave_wr_cmd_width_adapter:out_ready
	wire    [1:0] hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_channel;                      // hps_0_f2h_axi_slave_wr_cmd_width_adapter:out_channel -> agent_pipeline:in_channel
	wire          hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_startofpacket;                // hps_0_f2h_axi_slave_wr_cmd_width_adapter:out_startofpacket -> agent_pipeline:in_startofpacket
	wire          hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_endofpacket;                  // hps_0_f2h_axi_slave_wr_cmd_width_adapter:out_endofpacket -> agent_pipeline:in_endofpacket
	wire          agent_pipeline_source0_valid;                                              // agent_pipeline:out_valid -> hps_0_f2h_axi_slave_agent:write_cp_valid
	wire  [153:0] agent_pipeline_source0_data;                                               // agent_pipeline:out_data -> hps_0_f2h_axi_slave_agent:write_cp_data
	...
	wire          hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_valid;                        // hps_0_f2h_axi_slave_rd_cmd_width_adapter:out_valid -> agent_pipeline_001:in_valid
	wire  [153:0] hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_data;                         // hps_0_f2h_axi_slave_rd_cmd_width_adapter:out_data -> agent_pipeline_001:in_data
	wire          hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_ready;                        // agent_pipeline_001:in_ready -> hps_0_f2h_axi_slave_rd_cmd_width_adapter:out_ready
	wire    [1:0] hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_channel;                      // hps_0_f2h_axi_slave_rd_cmd_width_adapter:out_channel -> agent_pipeline_001:in_channel
	wire          hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_startofpacket;                // hps_0_f2h_axi_slave_rd_cmd_width_adapter:out_startofpacket -> agent_pipeline_001:in_startofpacket
	wire          hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_endofpacket;                  // hps_0_f2h_axi_slave_rd_cmd_width_adapter:out_endofpacket -> agent_pipeline_001:in_endofpacket
	wire          agent_pipeline_001_source0_valid;                                          // agent_pipeline_001:out_valid -> hps_0_f2h_axi_slave_agent:read_cp_valid
	wire  [153:0] agent_pipeline_001_source0_data;                                           // agent_pipeline_001:out_data -> hps_0_f2h_axi_slave_agent:read_cp_data
	...
	wire  [153:0] hps_0_f2h_axi_slave_agent_write_rp_data;                                   // hps_0_f2h_axi_slave_agent:write_rp_data -> agent_pipeline_002:in_data
	...
	wire  [153:0] agent_pipeline_002_source0_data;                                           // agent_pipeline_002:out_data -> router_001:sink_data
	...
	wire  [153:0] hps_0_f2h_axi_slave_agent_read_rp_data;                                    // hps_0_f2h_axi_slave_agent:read_rp_data -> agent_pipeline_003:in_data
	...
	wire  [153:0] agent_pipeline_003_source0_data;                                           // agent_pipeline_003:out_data -> router_002:sink_data
	...
	altera_merlin_axi_slave_ni #(
		...
		.aclk                   (video_pll_outclk0_clk),                                             //        clock_sink.clk
	...
	altera_avalon_st_pipeline_stage #(
		...
		.reset             (hps_only_master_master_translator_reset_reset_bridge_in_reset_reset), // cr0_reset.reset
		.in_ready          (hps_only_master_master_limiter_cmd_src_ready),                        //     sink0.ready
		.in_valid          (hps_only_master_master_limiter_cmd_src_valid),                        //          .valid
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_ready          (hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_ready),               //     sink0.ready
		.in_valid          (hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_valid),               //          .valid
		.in_startofpacket  (hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_startofpacket),       //          .startofpacket
		.in_endofpacket    (hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_endofpacket),         //          .endofpacket
		.in_data           (hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_data),                //          .data
		.in_channel        (hps_0_f2h_axi_slave_wr_cmd_width_adapter_src_channel),             //          .channel
	...
	altera_avalon_st_pipeline_stage #(
		...
		.clk               (video_pll_outclk0_clk),                                            //       cr0.clk
		.reset             (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // cr0_reset.reset
		.in_ready          (hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_ready),               //     sink0.ready
		.in_valid          (hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_valid),               //          .valid
		.in_startofpacket  (hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_startofpacket),       //          .startofpacket
		.in_endofpacket    (hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_endofpacket),         //          .endofpacket
		.in_data           (hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_data),                //          .data
		.in_channel        (hps_0_f2h_axi_slave_rd_cmd_width_adapter_src_channel),             //          .channel
