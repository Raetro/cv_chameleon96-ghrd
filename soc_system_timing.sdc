...
###############################################################################
## USB BlasterII, 25MHz (better reliability)
###############################################################################
...
# This automatically constrains the h2f_user0_clk coming from the HPS since it
# is driven by a PLL and defined in the HPS setup as 50MHz
###############################################################################
derive_pll_clocks

###############################################################################
# Ignore timing for this test led path - (!!!REMOVE FROM FINAL DESIGN!!!)
###############################################################################
# set_false_path -from {soc_system:u0|altera_reset_controller:rst_controller_002|altera_reset_synchronizer:alt_rst_sync_uq1|altera_reset_synchronizer_int_chain_out} -to {led2_counter[*]}
...
###############################################################################
# HPS peripherals port false path setting to workaround the unconstrained path
# (false_path for hps_0 ports will not affect the routing as they're hard silicon)
###############################################################################
